...
Resolve every relative script and reference path against this skill's root directory (the directory containing this `SKILL.md`), regardless of the repository working directory.
